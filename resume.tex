...
\small
	...
	\section{Employment}
		\begin{multicols}{2}
			...
			\begin{project1}{Software Engineer}{FarPost LLC. Vladivostok, 2012 -- present}
				\begin{items}
          \item Enhanced internal development tool adding the ability to generate layouts for the new projects.
					\item Introduced OpenID authentication for the company web services. Implemented OpenID relying part package and integrated it in existing projects.
					%\item Enhance existing tool, adding abillity to analyze user behaviour using url patterns.
				\end{items}
			\end{project1}
